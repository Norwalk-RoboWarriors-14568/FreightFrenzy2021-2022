...
@Autonomous(name = "🟥🟥🟥🟥🟥🟥🟥 Red Car 3")
public class AAARedCarousel_Copy2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //run autonomous
        if (opModeIsActive()) {
            encoderDrive(0.5,0.5,10,10);
            sleep(300);
            encoderDrive(0.3,0.3,4.9,-4.9);
            int i = 1;
            /*
            while (openCv.analysis() != 2){
                drive(0.1,-0.1);//turn towards hu    
                telemetry.addData("Pos", openCv.analysis());
                telemetry.addData("I val:", i++);
                telemetry.update(); 
 //clashroyaletradetokensballons10/12jacobssbu              
            
            }*/
            sleep(300);
            encoderDrive(0.5,0.5,7,7);
            sleep(300);
            hubLevel(3); 
            sleep(300);

            encoderDrive(0.3,0.3,4.4,-4.4);
            sleep(300);
            encoderDrive(0.5,0.5,-33.5,-33.5);
            motorDuck.setPower(0.5);
            sleep(300);
            motorDuck.setPower(1);
            sleep(1450);
            /*encoderDrive(1,1,6,0));
            encoderDrive(1,1,-10,-10);
            spinDuck(0.7);
            encoderDrive(1,1,10,10);
           ...
           //drop preload in hub at hubLevel
