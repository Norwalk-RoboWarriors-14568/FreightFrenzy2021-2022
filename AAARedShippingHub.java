...
@Autonomous(name = "Red Shipping Hub")
public class AAARedShippingHub extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            // ZERO RING
            odometryDrive(5, 0.2, 0.8, 22, 40, false);//Arc
            sleep(2000);
            extendOrRetract(-2);//extend or retract - is extend and + is retract// based off time do not put over 4
            spitOut(-1);

            odometryDrive(2.6, -1, 1, -14, 14, false);//Back straight
            sleep(2000);
            odometryDrive(2.6, -1, -1, -84, -80, false);//Back straight
            sleep(2000);
            odometryDrive(2.6, -1, 1, -27, 20, false);//Back straight
            sleep(2000);
