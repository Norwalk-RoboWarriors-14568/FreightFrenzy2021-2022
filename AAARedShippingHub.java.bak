...
public class AAARedCarousel extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            motorSetModes(DcMotor.RunMode.RUN_USING_ENCODER);       //start encoders
                ...
                encoderDrive(1, 1, -3, 1);//STRAIGHT
                spinDuck(0.7);
                sleep(300);
                encoderDrive(0.3, 0.3 ,14, 14);//Arc To shipping Hub
                ...
                encoderDrive(0.3, 0.3, 1, -1.5);
                sleep(500);
                
                encoderDrive(0.2, 0.2 ,16, 16);
                encoderDrive(0.3, 0.3, 2, -2);
                ...
                hubLevel(hubLevel);
                encoderDrive( 0, 0.5,3.5,- 7);
                sleep(9000);

                encoderDrive( 0.95, 1,90,90);
                //
    ...
    public void hubLevel(int level){
        if (level == 1){
            ...
            elevateArm(1.3, -0.8);
            extendOrRetract(1, 1);//layer 2 = 1 seconds, lsyer 1 is 0 secondselevateArm(1, -0.6);
            ...
            extendOrRetract(1, 1);//layer 2 = 1 seconds, lsyer 1 is 0 seconds
            elevateArm(1, -0.6);
            sleep(2000);
            spitOut(-.3);
            elevateArm(1, 0.6);
